...
PointcloudViewer::PointcloudViewer(QWidget *parent)
    : QMainWindow(parent), ui(new Ui::PointcloudViewer) {
  ui->setupUi(this);
...
PointcloudViewer::~PointcloudViewer() { delete ui; }
 ...
 */
void PointcloudViewer::showPointcloud(pcl::PointCloud<pcl::PointXYZRGB>::Ptr pc,
                                      int index) {
 ...
 */
void PointcloudViewer::showCoordinateSystem(const Eigen::Affine3f &tf,
