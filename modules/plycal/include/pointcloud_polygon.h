...
class PointcloudPolygon {
 ...
 private:
  ...
  bool ExtractRings(const PCI& pc, const Indices& indices, Indices& inlier,
                    Indices& left, Indices& right);
  bool ExtractEdges(const PCI& pc, Indices& indices, Edge3D& edge0,
                    Edge3D& edge1);
  void FitLine(const PCI& pc, const Indices& indices, Indices& inlier,
               Eigen::Vector3d& coef, Eigen::Vector3d& pt);
  ...
  bool ExtractEdgesMems(const PCI& pc, Indices& indices, Edge3D& edge0,
                        Edge3D& edge1, bool is_left);
};
